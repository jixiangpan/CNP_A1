...
///////////////////////////////////////////////////////////////////
  ...
  lhcbStyle->SetPadRightMargin(0.12); // increase for colz plots
  lhcbStyle->SetPadBottomMargin(0.12);
  lhcbStyle->SetPadLeftMargin(0.12);
  ...
  //lhcbStyle->SetOptStat("emrn");  // show only nent -e , mean - m , rms -r, name -n
  // full opts at http://root.cern.ch/root/html/TStyle.html#TStyle:SetOptStat
  lhcbStyle->SetStatFormat("6.3g"); // specified as c printf options
  lhcbStyle->SetOptTitle(0);
  lhcbStyle->SetOptFit(1);
  //lhcbStyle->SetOptFit(1011); // order is probability, Chi2, errors, parameter
  //titles
  ...
  lhcbStyle->SetStatX(0.99);// Jixp
  lhcbStyle->SetStatY(0.99);
  lhcbStyle->SetStatW(0.22);
  lhcbStyle->SetStatH(0.9);
